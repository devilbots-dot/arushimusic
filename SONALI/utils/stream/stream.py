...
async def stream(
    ...
    # Only check URL for stream types that actually use URLs
    if streamtype in ["youtube", "live", "index", "spotify", "apple", "soundcloud", "resso"]:
        # result may be a dict (youtube/live/index) or string (direct URL)
